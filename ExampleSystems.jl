...
sys = [
    a*mu1 + (1 − a)*mu2,
    a*(mu1^2 + s1^2) + (1 − a)*(mu2^2 + s2^2),
    a*(mu1^3 + 3*mu1*s1^2) + (1 − a)*(mu2^3 + 3*mu2*s2^2),
    a*(mu1^4 + 6*mu1^2*s1^2 + 3*s1^4) + (1 − a)*(mu2^4 + 6*mu2^2*s2^2 + 3*s2^4),
    a*(mu1^5 + 10*mu1^3*s1^2 + 15*mu1*s1^4) + (1 − a)*(mu2^5 + 10*mu2^3*s2^2 + 15*mu2*s2^4),
    a*(mu1^6 + 15*mu1^4*s1^2 + 45*mu1^2*s1^4 + 15*s1^6) + (1 − a)*(mu2^6 + 15*mu2^4*s2^2 + 45*mu2^2*s2^4 + 15*s2^6),
]
push!(ExampleSystems, (sys, vars))
